...
export async function generateMetadata({ params }: any) {
  ...
  return {
    ...
    keywords: [
      `${res?.title! || res?.name! || "MovieChill"} tv show`,
      `${res?.title! || res?.name! || "MovieChill"} tv show online`,
      `${res?.title! || res?.name! || "MovieChill"} tv show free`,
      `${res?.title! || res?.name! || "MovieChill"} tv show free online`,
      `${
        res?.title! || res?.name! || "MovieChill"
      } tv show free online streaming`,
      `${res?.title! || res?.name! || "MovieChill"} tv show free online watch`,
      `${
        res?.title! || res?.name! || "MovieChill"
