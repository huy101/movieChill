...
export async function generateMetadata({ params }: any) {
  ...
  return {
    ...
    keywords: [
      `${res?.title! || res?.name! || "MovieChill"} movie`,
      `${res?.title! || res?.name! || "MovieChill"} movie online`,
      `${res?.title! || res?.name! || "MovieChill"} movie free`,
      `${res?.title! || res?.name! || "MovieChill"} movie free online`,
      `${
        res?.title! || res?.name! || "MovieChill"
      } movie free online streaming`,
      `${res?.title! || res?.name! || "MovieChill"} movie free online watch`,
      `${
        res?.title! || res?.name! || "MovieChill"
