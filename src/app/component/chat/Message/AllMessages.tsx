      ...
      if (
        ...
        return (
          <div className="flex items-center justify-center h-screen">
            {" "}
            <h1 className="text-2xl text-neutral-400">Chưa có cuộc trò chuyện</h1>
          </div>
        );
      }
      return (
        <div className="flex items-center justify-center h-screen">
          {" "}
          <h1 className="text-2xl text-neutral-400">Có lỗi</h1>
        </div>
      );
    }
          ...
          <>
            {isTyping && (
              <div className="flex items-center justify-start mb-2 mt-4 ">
                <p className="text-neutral-500 font-light italic">Đang nhập...</p>
              </div>
            )}
          </>
        </section>
