    ...
    <Suspense>
      <section className="mt-14">
        <div className="flex max-md:flex-col max-md:items-start justify-between items-center sticky top-0">
          <h3 className="text-xl font-medium ">Phim và Truyền hình :</h3>
          <section className="flex gap-2 mr-8 max-md:mt-3 flex-wrap">
            ...
            >
              <option value="alpha-asc">Theo thứ tự chữ cái (A-Z)</option>
              <option value="alpha-desc">Theo thứ tự chữ cái (Z-A)</option>
              <option value="date-asc">Ngày ra mắt (Lâu nhất)</option>
              <option value="date-desc">Ngày ra mắt (Mới nhất)</option>
              <option value="rating-asc">Xếp hạng (Cao đến Thấp)</option>
              <option value="rating-desc">Xếp hạng (Thấp đến Cao)</option>=
            </select>
